<?php require __DIR__ . "/../DB/db_connect.php"; ?>
                                    ...
                                    <div class="card-body">
                                        <div class="dash-widget-header">
                                            <div>
                                                ...
                                                <h6 class="text-muted">Total Room Categories</h6>
                                            </div>
                                            <div class="ml-auto mt-md-3 mt-lg-0" style="text-align: right;"> <span class="opacity-7 text-muted">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#009688" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-database">
                                ...
                                <div class="card board1 fill">
                                    <div class="card-body">
                                        <div class="dash-widget-header">
                                            ...
                                            <!-- <h3 class="card_widget_header text-center"><?php echo '$';
                                                                                        include 'counters/payment_count.php' ?></h3> -->
                                        </div>
                                    </div>
                                </div>
                            </div>
